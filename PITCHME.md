...
@snap[west span-49 text-07 text-left text-white]
...
@snap[south-west span-49 text-07 text-left text-white]
...
@snap[east span-49 text-07 text-left text-black]
...
@snap[south-east span-49 text-07 text-left text-black]
